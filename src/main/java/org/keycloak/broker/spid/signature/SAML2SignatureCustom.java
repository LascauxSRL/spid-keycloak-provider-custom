...
public class SAML2SignatureCustom {
    ...
    public Document sign(Document doc, String referenceID, String keyName, KeyPair keyPair, String canonicalizationMethodType) throws ParserConfigurationException,
        ...
        if (sibling != null) {
            ...
            return XMLSignatureUtilCustom.sign(dto, canonicalizationMethodType);
        }
        return XMLSignatureUtilCustom.sign(doc, keyName, keyPair, digestMethod, signatureMethod, referenceURI, x509Certificate, canonicalizationMethodType);
    }
